...
%%%%%%%%%%%%%%%%
% Title
\title{Summarizing High-dimensional Feature Vectors}
...
\include{QueryLogSummarization/main}
\include{TKDE-QuerySimilarity/main}
\include{SchemaSummarization/main}
\include{ProbabilisticDatabaseSummarization/main}
